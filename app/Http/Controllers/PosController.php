...
class PosController extends Controller
{
    public function index(Request $request)
    {
        ...
        $year = date('y');
        $nextOrderId = "HB/{$year}/" . str_pad($nextId, 3, '0', STR_PAD_LEFT);
    ...
    public function submit(Request $request)
    {
        ...
        try {
            ...
            $sale = Sale::create([
                ...
                // order_id will be auto-generated by SaleObserver
            ...
            // Refresh the sale to get the auto-generated order_id from the observer
            $sale->refresh();
